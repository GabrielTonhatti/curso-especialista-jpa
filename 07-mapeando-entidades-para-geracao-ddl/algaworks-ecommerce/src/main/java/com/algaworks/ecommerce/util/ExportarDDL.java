...
public class ExportarDDL {
    ...
    public static void main(String[] args) {
        ...
        propriedades.put("javax.persistence.schema-generation.scripts.create-target", "/home/gabriel/Desktop/script-criacao-exportado.sql");
        propriedades.put("javax.persistence.schema-generation.scripts.drop-target", "/home/gabriel/Desktop/script-remocao-exportado.sql");
